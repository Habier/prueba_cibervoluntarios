...
final class Version20260507190000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fleets (id UUID NOT NULL, name VARCHAR(255) NOT NULL, client_name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE vehicles (id UUID NOT NULL, vehicle_type_id UUID NOT NULL, fleet_id UUID DEFAULT NULL, plate VARCHAR(32) NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_VEHICLES_PLATE ON vehicles (plate)');
        $this->addSql('CREATE INDEX IDX_VEHICLES_FLEET_ID ON vehicles (fleet_id)');
        ...
        $this->addSql('ALTER TABLE vehicles ADD CONSTRAINT FK_VEHICLES_FLEET FOREIGN KEY (fleet_id) REFERENCES fleets (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS fleets');
    }
}
